...
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, ChannelName, INI_LoginInfo_ChannelName)
...
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, ResolutionWidth, INI_DeviceInfo_ResolutionWidth)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, ResolutionHeight, INI_DeviceInfo_ResolutionHeight)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, SwitchWHEnable, INI_DeviceInfo_SwitchWHEnable)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, ResolutionFps, INI_DeviceInfo_ResolutionFps)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, ResolutionBitrate, INI_DeviceInfo_ResolutionBitrate)

__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpSave, INI_DeviceInfo_RtmpSave)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpUrl, INI_DeviceInfo_RtmpUrl)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpWidth, INI_DeviceInfo_RtmpWidth)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpHeight, INI_DeviceInfo_RtmpHeight)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpFps, INI_DeviceInfo_RtmpFps)
__IMPLEMENT_INICONFIG_SIMILAR_FUN(CConfigWawaji, RtmpBitrate, INI_DeviceInfo_RtmpBitrate)