...
// Construction
public:
    CAgoraWawajiDemoDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_AGORAWAWAJI_DIALOG };
...
protected:
	...
	afx_msg LRESULT OnEIDLastmileQuality(WPARAM wParam, LPARAM lParam);
